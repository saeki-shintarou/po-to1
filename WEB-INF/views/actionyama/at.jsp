...
<h3><c:out value="${chara.name}" />のこうげき<c:out value="${chara.power}" />のダメージ‼︎‼︎</h3>
<h3>やまうさぎの攻撃とびはねる！ミス‼︎‼︎ダメージをあたえられない</h3>
<h3><a href="<c:url value='/actionyama/act2?id=${chara.id}' />">→　　次へ</a></h3>
